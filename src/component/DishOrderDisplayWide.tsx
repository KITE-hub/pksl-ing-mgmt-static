    ...
    <div className="DishOrderDisplay2">
      <div className="mt-3 mb-4">
        <div className="flex mb-3">
          ...
          <h3 className="font-bold text-white bg-[#fe8b71] px-2 w-full clipSlant">カレー・シチュー</h3>
      ...
      <div className="mt-3 mb-4">
        <div className="flex mb-3">
          ...
          <h3 className="font-bold text-white bg-[#f6bd5a] px-2 w-full clipSlant">デザート・ドリンク</h3>
        </div>
